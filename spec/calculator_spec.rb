...
RSpec.describe Calculator do
  ...
  let(:commission_entity) do
    Calculator::Commission.new(user: basic_user,
  ...
  describe 'IndividualEntrepreneurUser' do
    let(:individual_entrepreneur_user) do
      User::IndividualEntrepreneurUser.new
    end

    let(:commission_entity) do
      Calculator::Commission
        .new(user: individual_entrepreneur_user,
             product: basic_product)
    end
  ...
  describe 'LegalEntityUser' do
    let(:legal_entity_user) { User::LegalEntityUser.new }
    let(:commission_entity) do
      Calculator::Commission
        .new(user: legal_entity_user,
             product: basic_product)
    end
    it 'calculates with with additional commision' do
      output = Calculator.call(amount: amount,
  ...
  describe 'SoftwareProduct' do
    let(:software_product) { Product::SoftwareProduct.new }
    let(:commission_entity) do
      Calculator::Commission
        .new(user: basic_user, product: software_product)
    end
  ...
  it 'calculates without commission_percent, commission_entity and
      commission_amount input' do
    output = Calculator.call(amount: amount)
